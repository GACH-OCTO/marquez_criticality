          ...
          "fields": {
            ...
            "additionalProperties": {
              ...
              "properties": {
                ...
                "transformationType": {
                   "type": "string",
                   "description": "IDENTITY|MASKED reflects a clearly defined behavior. IDENTITY: exact same as input; MASKED: no original data available (like a hash of P1 for example)"
                }
              },
              "additionalProperties": true,
